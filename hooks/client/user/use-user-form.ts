import { C_ALL_USERS_ROUTE } from "@/core/routes";
...
type PermissionModule = keyof IClientPermissions;
...
const useUserForm = ({
  ...
  defaultValues: IClient | undefined | null;
}) => {
