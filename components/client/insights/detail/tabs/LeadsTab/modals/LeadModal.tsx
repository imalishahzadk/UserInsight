  ...
  return (
    <Modal open={open} onClose={onClose} aria-labelledby="lead-modal">
      ...
      >
        ...
        >
          <Typography variant="h6">Lead Analytics Dashboard</Typography>
        ...
        <Box sx={{ p: 3, color: "#fff" }}>
          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={6}>
              <DataRow label="Session ID" value={lead.sessionId} />
            </Grid>
            <Grid item xs={6}>
              <DataRow label="User ID" value={lead.userId} />
            </Grid>
            <Grid item xs={6}>
              <DataRow label="Insight ID" value={lead.insightId} />
            </Grid>
            <Grid item xs={6}>
              <DataRow
                label="Address"
                  ...
                  analytics.location
                    ?.map(
                      (g: {
                        ...
                        `${g.city}, ${g.state}, ${g.country} (long: ${g.latitude}, lat: ${g.longitude})`
                    )
                    .join(", ") || "N/A"
                }
              />
        ...
        <Box sx={{ p: 3, color: "#fff" }}>
          ...
          <Grid container spacing={3}>
            <Grid item xs={6}>
              <DataRow label="Total Sessions" value={analytics.totalSessions} />
              <DataRow
